...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Shamelion/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Shamelion/${id}/branches`)
    .then((response) => (response.json()))
    .then((data) => {
      setBranch(data)
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Shamelion/${id}/deployments`)
    .then((response) => (response.json()))
    .then((data) => {
      setDeployment(data)
    })
